...
contract SimpleBank {
    ...
    function balance() public view returns (uint) {
        ...
        //must have an account at the bank
        require(
            enrolled[accountAddress]
        );
        _balance = balances[accountAddress];
        return _balance;
    ...
    function deposit() public payable returns (uint) {
        ...
        balances[accountAddress] += _deposit;
        emit LogDepositMade(accountAddress, _deposit);
